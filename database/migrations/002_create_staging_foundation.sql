...
CREATE TABLE IF NOT EXISTS staging.matches (
    ...
    is_administrative_result BOOLEAN NOT NULL DEFAULT FALSE,
    administrative_result_type TEXT,
    administrative_note TEXT,
    played_on_pitch BOOLEAN NOT NULL DEFAULT TRUE,
    home_awarded_points INTEGER,
    away_awarded_points INTEGER,
    is_source_anomaly BOOLEAN NOT NULL DEFAULT FALSE,
    source_anomaly_reason TEXT,
