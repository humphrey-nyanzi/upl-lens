...
def test_recent_completed_urls_selects_latest_complete_matches() -> None:
    ...
    rows = [
        {"match_url": "old", "date": "2025-01-01", "match_day": 1, "match_id": 1, "home_score": 1, "away_score": 0},
        {"match_url": "new", "date": "2025-02-01", "match_day": 2, "match_id": 2, "home_score": 2, "away_score": 2},
        {"match_url": "future", "date": "2025-03-01", "match_day": 3, "match_id": 3, "home_score": None, "away_score": None},
    ]
...
def test_remove_match_rows_replaces_stale_payload_rows() -> None:
    ...
    tables = {
        ...
        "events": [{"match_url": "refresh", "event_index": 1}, {"match_url": "keep", "event_index": 1}],
    }
...
def test_filter_existing_tables_to_calendar_drops_removed_source_matches() -> None:
    ...
    tables = {
        ...
        "events": [{"match_url": "listed", "event_index": 1}, {"match_url": "removed", "event_index": 1}],
    }
